...
import { ReplenishmentPreviewModal } from '../components/replenishment/ReplenishmentPreviewModal';
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                >
                  <FileText size={18} />
                  自動建立撥補單 {itemsNeedingReplenishment.length > 0 && `(${itemsNeedingReplenishment.length})`}
                </button>
                <button
                ...
                >
                  <FileText size={18} />
                  建立選擇品項撥補單 {manuallySelectedItems.size > 0 && `(${manuallySelectedItems.size})`}
                </button>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
      ...
      {selectedServer && (
        <div className="bg-white rounded-lg shadow-sm border border-slate-200">
          <div className="sticky top-0 z-10 bg-slate-50 border-b border-slate-200 p-4">
            ...
            <p className="text-sm text-slate-600 mt-1">建議撥補資訊（最近30天平均消耗量）</p>
          </div>
